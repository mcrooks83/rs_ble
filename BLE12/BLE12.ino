...
#define INTERRUPT_PIN PIN_A1
//#define POWER_PIN PIN_A2
...
void SysTick_Handler(void)
{
  ...
  if(enableInt == 1){
    ...
    digitalWrite(INTERRUPT_PIN, !digitalRead(INTERRUPT_PIN));
...
//{
//      pixels.setPixelColor(0, pixels.Color(random(0, 10), random(0, 10), random(0, 10)));
//      pixels.show();
...
//  pinMode(WAKE_LOW_PIN, INPUT_PULLUP);
...
//  ISR_Timer.setInterval(TIMER_INTERVAL_xS,  doingSomething1);
  ...
  //attachInterrupt(WAKE_LOW_PIN, digital_callback, ISR_DEFERRED | FALLING );
